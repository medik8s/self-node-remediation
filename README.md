# Self Node - Automatic Kubernetes Node Remediation 
...
This self node controller is using an alternate mechanism for a node in a cluster to detect its health
...
## Project State
The operator is available in [operator hub](https://operatorhub.io/operator/self-node-operator)
