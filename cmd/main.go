...
import (
	...
	"github.com/medik8s/self-node-remediation/v5/internal/snrconfighelper"
	"github.com/medik8s/self-node-remediation/v5/internal/template"
	"github.com/medik8s/self-node-remediation/v5/internal/utils"
	"github.com/medik8s/self-node-remediation/v5/internal/watchdog"
	webhookv1alpha1 "github.com/medik8s/self-node-remediation/v5/internal/webhook/v1alpha1"
	"github.com/medik8s/self-node-remediation/v5/version"
