...
# This variable is used to construct full image tags for bundle
#
# For example, running 'make bundle-build bundle-push' will build and push medik8s/self-node-remediation-bundle:$(IMAGE_TAG).
