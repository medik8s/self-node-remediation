...
var managerReconciler *controller.SelfNodeRemediationReconciler
...
var _ = BeforeSuite(func() {
	...
	err = ctrl.NewControllerManagedBy(k8sManager).
		...
		Complete(&controller.SelfNodeRemediationReconciler{
			Client:     k8sClient,
	...
	managerReconciler = &controller.SelfNodeRemediationReconciler{
		Client:     k8sClient,
